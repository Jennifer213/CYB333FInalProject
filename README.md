...
Running the Scanner
Configure the targets and port range in the vulnerabilityScanner.py file:

TARGETS = ["127.0.0.1", "scanme.nmap.org"]
PORT_RANGE = range(0, 1025)
Ensure the vulnerability_db.json file exists in the same directory and contains up-to-date vulnerabilities. Example:
...
View results in the console or the generated vulnerability_report.csv file.
